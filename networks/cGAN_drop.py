...
class Decode(nn.Module):
    ...
    def __init__(self, in_channels, out_channels,dropout=0.0, bilinear=True):
        ...
        self.conv = DoubleConv(in_channels, out_channels,dropout=0.0)
...
class Unet(nn.Module):
    ...
    def __init__(self, in_ch=1, n_classes=1, bilinear=True):
        ...
        self.inc = DoubleConv(in_ch, self.in_fch,dropout=0.1)
        self.encode1 = Encode(self.in_fch, self.in_fch*2,dropout=0.1)
        self.encode2 = Encode(self.in_fch*2, self.in_fch*4,dropout=0.2)
        self.encode3 = Encode(self.in_fch*4, self.in_fch*8,dropout=0.2)
        self.encode4 = Encode(self.in_fch*8, self.in_fch*8,dropout=0.3)
        self.decode1 = Decode(self.in_fch*16, self.in_fch*4,0.2, bilinear)
        self.decode2 = Decode(self.in_fch*8, self.in_fch*2,0.2, bilinear)
        self.decode3 = Decode(self.in_fch*4, self.in_fch,0.1, bilinear)
        self.decode4 = Decode(self.in_fch*2, self.in_fch,0.1, bilinear)
